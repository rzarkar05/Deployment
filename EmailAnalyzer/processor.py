...
import EmailAnalyzer.pdf
import spacy
import pandas as pd
import joblib 
"""
def model():
    emails = pd.read_csv('EmailAnalyzer/resources/zPDFS/emails.csv')
...
loaded_spam_model = joblib.load('EmailAnalyzer/resources/spam_model.pkl')


##CREATES DATAFRAME
def create_df(input):
    #GET DATA
    df = EmailAnalyzer.pdf.return_df(input)
    #SPAM
