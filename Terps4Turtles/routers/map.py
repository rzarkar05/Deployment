...
from Terps4Turtles.routers.auth import get_curr_user
...
data = pd.read_csv('Terps4Turtles/static/ICARUS Galapagos tortoises.csv')
...
def map(tag,day):
    ...
    map_with_points.save('Terps4Turtles/templates/map.html')
